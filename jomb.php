...
<head>
	...
	<title>淡江大學童軍團40週年暨財團法人剛毅童軍文教基金會15週年 團慶大露營</title>
	        <!-- 基本meta定義 -->
...
<section class="intro-section">
			<div class="intro">
		    <h2 style="font-size:35px;">歡迎來到40週年團慶大露營專頁</h2>
			<img src="images/jomb_cphoto.jpg" style="width:60%;">
			</div>
		</section>
...
<section class="four-columns">
			<div class="container line-anim">
				<a href="jomb_intro.php">
				<div class="column anim-box" id="column1">
					<div class="inner"> 
						<div id="icon-ani">
						<span data-picture data-alt="團慶大露營簡介">
							...
							<![endif]-->
							<noscript><img src="images/4col-01.png" width="100"  alt="團慶大露營簡介" ></noscript>
						</span>
						<h2 style="font-size:25px;font-family">團慶大露營簡介</h2><br/>
						</div>
					</div>
				</div>
			</a>
				...
				<div class="column anim-box" id="column2">
					<div class="inner">
						<div id="icon-ani2">
						<span data-picture data-alt="行前通知">
							...
							<![endif]-->
							<noscript><img src="images/4col-02.png" width="100"  alt="行前通知" ></noscript>
						</span>
						<h2 style="font-size:25px;">行前通知</h2><br/>
						</div>
					</div>
				</div>
				</a>
				...
				<div class="column anim-box" id="column3">
					<div class="inner">
						<div id="icon-ani3">
						<span data-picture data-alt="報名系統">
							...
							<![endif]-->
							<noscript><img src="images/4col-03.png" width="100"  alt="報名系統" ></noscript>
						</span>
						<h2 style="font-size:25px;">報名系統</h2><br/>
						</div>
					</div>
				</div>
				</a>

				<a href="https://www.flickr.com/photos/scoutjeffrey/sets/72157646293014971/">
				<div class="column anim-box" id="column4">
					<div class="inner">
						<div id="icon-ani4">
						<span data-picture data-alt="精彩照片集">
							...
							<![endif]-->
							<noscript><img src="images/4col-04.png" width="100" alt="精彩照片集" ></noscript>
						</span>
						<h2 style="font-size:25px;">精彩照片集</h2><br/>
						</div>
					</div>
				</div>
			</a>
